...
var _Support = __webpack_require__(76);

var _Support2 = _interopRequireDefault(_Support);

var _Reader = __webpack_require__(75);
...
var _InvalidDefinitionError = __webpack_require__(156);

var _InvalidDefinitionError2 = _interopRequireDefault(_InvalidDefinitionError);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var INJECT_ANNOTATION_NAME = 'Inject';
...
var Resolver = function () {
     ...
     * @private
     */
    function Resolver(container /*: Container*/, service /*: any*/) {
        (0, _classCallCheck3.default)(this, Resolver);
        this._parameters = null;

        this._resolvedEvent = function (service) {};
    ...
    (0, _createClass3.default)(Resolver, [{
        key: "fireResolvedEvent",
        value: function fireResolvedEvent(service /*: any*/) /*: Resolver*/ {
            var force /*: boolean*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
         ...
         * @return {Resolver}
         */
        value: function resolved(callback /*: Function*/) /*: Resolver*/ {
        ...
        value: function resolve() /*: any*/ {
            var service = this._service(this.getDependencies.apply(this, arguments));
        ...
        key: "getDependencies",
        value: function getDependencies() /*: Array*/ {
            var result = [];
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)(this.getParameters.apply(this, arguments)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    try {
                        ...
                        if (e instanceof TypeError) {
                            var error = "Unresolvable dependency resolving [" + dependency + "] " + ("while resolving " + _Support2.default.getName(this._service));

                            throw new _InvalidDefinitionError2.default(error);
                        }
                        throw e;
                    }
                }
        ...
        key: "getParameters",
        value: function getParameters() /*: Array*/ {
            ...
            if (this._parameters === null) {
                ...
                if (reader === null) {
                    return [_Container.CONTAINER_IDENTIFIER];
                }

                var annotation = reader.getClassAnnotation(INJECT_ANNOTATION_NAME);
        ...
        key: "getReader",
        value: function getReader() /*: ?Reader*/ {
            if (_Support2.default.isClass(this.service)) {
                return new _Reader2.default(this.service);
            }

            if (_Support2.default.isObject(this.service)) {
                return new _Reader2.default(this.service.constructor);
            }
...
exports.Annotation = exports.Inject = exports.Target = exports.Reader = exports.Container = undefined;

var _Container2 = __webpack_require__(100);

var _Container3 = _interopRequireDefault(_Container2);

var _Reader2 = __webpack_require__(75);

var _Reader3 = _interopRequireDefault(_Reader2);

var _Target2 = __webpack_require__(98);

var _Target3 = _interopRequireDefault(_Target2);

var _Inject2 = __webpack_require__(99);

var _Inject3 = _interopRequireDefault(_Inject2);

var _Annotation2 = __webpack_require__(97);

var _Annotation3 = _interopRequireDefault(_Annotation2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.Container = _Container3.default;
exports.Reader = _Reader3.default;
exports.Target = _Target3.default;
exports.Inject = _Inject3.default;
exports.Annotation = _Annotation3.default;
...
var _defineMetadata = __webpack_require__(222);

var _defineMetadata2 = _interopRequireDefault(_defineMetadata);

var _getMetadata = __webpack_require__(223);
 ...
 * @type {Symbol}
 */
var METADATA_CLASS = (0, _symbol2.default)('METADATA_CLASS');
 ...
 * @type {Symbol}
 */
var METADATA_METHOD = (0, _symbol2.default)('METADATA_METHOD');
 ...
 * @type {Symbol}
 */
var METADATA_PROPERTY = (0, _symbol2.default)('METADATA_PROPERTY');
 ...
 * @type {string}
 */
var DEFAULT_META_KEY = (0, _symbol2.default)('default');
...
var Reader = function () {
     ...
     */
    function Reader(_class /*: Function*/) {
    ...
    (0, _createClass3.default)(Reader, [{
        key: '_boot',
        value: function _boot(type) {
            var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_META_KEY;

            var data = (0, _getMetadata2.default)(type, this._class) || {};

            if (typeof data[key] === 'undefined') {
                data[key] = [];
                (0, _defineMetadata2.default)(type, data, this._class);
            }
        }
        ...
        key: 'getMetadata',
        value: function getMetadata(type /*: any*/) /*: Array*/ {
            var key /*: string*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_META_KEY;

            this._boot(type, key);

            var items = (0, _getMetadata2.default)(type, this._class)[key];
        ...
        key: 'getMetadataKeys',
        value: function getMetadataKeys(type /*: any*/) /*: Array*/ {
            this._boot(type);

            var result = [];
            var items = (0, _getMetadata2.default)(type, this._class);
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)((0, _keys2.default)(items)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var key = _step.value;
        ...
        key: 'getMethodsMetadataKeys',
        value: function getMethodsMetadataKeys() /*: Array*/ {
        ...
        key: 'getPropertiesMetadataKeys',
        value: function getPropertiesMetadataKeys() /*: Array*/ {
        ...
        key: 'addMetadata',
        value: function addMetadata(annotation /*: Object*/, type /*: any*/) /*: void*/ {
            var key /*: string*/ = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_META_KEY;
        ...
        key: 'getClassAnnotations',
        value: function getClassAnnotations() /*: Array*/ {
        ...
        key: 'getClassAnnotation',
        value: function getClassAnnotation(annotationName /*: string*/) /*: ?Object*/ {
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;

            try {
                for (var _iterator2 = (0, _getIterator3.default)(this.getClassAnnotations()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        key: 'addClassAnnotation',
        value: function addClassAnnotation(annotation /*: Object*/) /*: Reader*/ {
        ...
        key: 'getMethodAnnotations',
        value: function getMethodAnnotations() /*: Array*/ {
            var methodName /*: ?string*/ = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
            ...
            if (methodName === null) {
                ...
                try {
                    for (var _iterator3 = (0, _getIterator3.default)(this.getMetadataKeys(METADATA_METHOD)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        key: 'getMethodAnnotation',
        value: function getMethodAnnotation(annotationName /*: string*/) /*: ?Object*/ {
            var methodName /*: ?string*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            var properties = methodName === null ? this.getMethodAnnotations() : [this.getMethodAnnotations(methodName)];
            ...
            try {
                for (var _iterator4 = (0, _getIterator3.default)(properties), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var annotations = _step4.value;
                    var _iteratorNormalCompletion5 = true;
                    var _didIteratorError5 = false;
                    var _iteratorError5 = undefined;

                    try {
                        for (var _iterator5 = (0, _getIterator3.default)(annotations), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        key: 'addMethodAnnotation',
        value: function addMethodAnnotation(methodName /*: string*/, annotation /*: Object*/) /*: Reader*/ {
        ...
        key: 'getPropertyAnnotations',
        value: function getPropertyAnnotations() /*: Array*/ {
            var propertyName /*: ?string*/ = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
            ...
            if (propertyName === null) {
                ...
                try {
                    for (var _iterator6 = (0, _getIterator3.default)(this.getMetadataKeys(METADATA_PROPERTY)), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        ...
        key: 'getPropertyAnnotation',
        value: function getPropertyAnnotation(annotationName /*: string*/) /*: ?Object*/ {
            var propertyName /*: ?string*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            var properties = propertyName === null ? this.getPropertyAnnotations() : [this.getPropertyAnnotations(propertyName)];
            ...
            try {
                for (var _iterator7 = (0, _getIterator3.default)(properties), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    var annotations = _step7.value;
                    var _iteratorNormalCompletion8 = true;
                    var _didIteratorError8 = false;
                    var _iteratorError8 = undefined;

                    try {
                        for (var _iterator8 = (0, _getIterator3.default)(annotations), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        ...
        key: 'addPropertyAnnotation',
        value: function addPropertyAnnotation(propertyName /*: string*/, annotation /*: Object*/) /*: Reader*/ {
...
var Support = function () {
    ...
    (0, _createClass3.default)(Support, null, [{
        key: 'getName',
         ...
         * @return {string}
         */
        value: function getName(nameOrClass /*: ServiceIdentifier*/) /*: string*/ {
            if (nameOrClass instanceof Function) {
                return nameOrClass.name;
            }

            if ((typeof nameOrClass === 'undefined' ? 'undefined' : (0, _typeof3.default)(nameOrClass)) === 'object') {
        ...
        key: 'isClass',
        value: function isClass(dependency /*: Function*/) /*: boolean*/ {
        ...
        key: 'isObject',
        value: function isObject(dependency /*: Object*/) /*: boolean*/ {
            return (typeof dependency === 'undefined' ? 'undefined' : (0, _typeof3.default)(dependency)) === 'object' && !(dependency instanceof Array) && dependency !== null;
        }
        ...
        key: 'isAnonymous',
        value: function isAnonymous(dependency /*: Function*/) /*: boolean*/ {
            return dependency instanceof Function && dependency.name === '';
        }
        ...
        key: 'getClass',
        value: function getClass(dependency /*: ServiceIdentifier*/) /*: Function*/ {
...
module.exports = __webpack_require__(50)|| !__webpack_require__(3)(function(){
  var K = Math.random();
...
var _Target = __webpack_require__(98);
 ...
 * @type {string}
 */
var DEFAULT_ANNOTATION_PROPERTY = 'default';
...
var Annotation = function () {
    (0, _createClass3.default)(Annotation, null, [{
        key: 'getTarget',
         ...
         * @return {string}
         */
        value: function getTarget(ctx, name, descr) /*: string*/ {
            if (ctx instanceof Function) {
                return _Target.TargetType.Class;
            }

            if (descr && typeof descr.value === 'function') {
                return _Target.TargetType.Method;
            }

            return _Target.TargetType.Property;
        }
        ...
        key: 'getName',
        value: function getName(ctx, name, descr) /*: string*/ {
            var type = this.getTarget(ctx, name, descr);

            return type === _Target.TargetType.Class ? ctx.name : name;
        }
        ...
        key: 'getClassContext',
        value: function getClassContext(ctx, name, descr) /*: Function*/ {
            var type = this.getTarget(ctx, name, descr);

            return type === _Target.TargetType.Class ? ctx : ctx.constructor;
        }
        ...
        key: 'info',
        value: function info(ctx, name, descr) {
            return {
        ...
        key: 'reader',
        value: function reader(ctx, descr) /*: Reader*/ {
            return new _Reader2.default(this.getClassContext(ctx, descr));
        }
     ...
     */
    function Annotation() {
        var args /*: Object*/ = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

        var _defaultProperty /*: string*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_ANNOTATION_PROPERTY;

        (0, _classCallCheck3.default)(this, Annotation);
        this._args = {};

        if ((typeof args === 'undefined' ? 'undefined' : (0, _typeof3.default)(args)) !== 'object' || args instanceof Array) {
            args = (0, _defineProperty3.default)({}, _defaultProperty, args);
        }
    ...
    (0, _createClass3.default)(Annotation, [{
        key: 'delegate',
        value: function delegate(targetAnnotation /*: Function*/) /*: Function*/ {
            var annotation = this.constructor._fill(targetAnnotation, this._args);

            return function (ctx, name, descr) {
                var info = Annotation.info(ctx, name, descr);
                var meta = Annotation.reader(ctx, descr);

                (0, _Target.check)(targetAnnotation, info);

                switch (info.target) {
                    case _Target.TargetType.Class:
                        meta.addClassAnnotation(annotation);
                        break;

                    case _Target.TargetType.Property:
                        meta.addPropertyAnnotation(info.name, annotation);
                        break;

                    case _Target.TargetType.Method:
        ...
        key: '_fill',
        value: function _fill(_class /*: Function*/) /*: Object*/ {
            var args /*: Object*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

            var instance = new _class(args);
...
exports.TargetType = exports.AnnotationTargetError = undefined;
...
exports.default = function (target) {
    return function (ctx, name, descr) {
        var info = _Annotation2.default.info(ctx, name, descr);

        if (info.target === TargetType.Class) {
            var annotation = new Target();
            annotation.targetings = target instanceof Array ? target : [target];

            new _Reader2.default(info.class).addClassAnnotation(annotation);
        }
...
var _Annotation = __webpack_require__(97);
 ...
 */
var AnnotationTargetError = exports.AnnotationTargetError = function (_TypeError) {
    (0, _inherits3.default)(AnnotationTargetError, _TypeError);

    function AnnotationTargetError() {
        (0, _classCallCheck3.default)(this, AnnotationTargetError);
        return (0, _possibleConstructorReturn3.default)(this, (AnnotationTargetError.__proto__ || (0, _getPrototypeOf2.default)(AnnotationTargetError)).apply(this, arguments));
    }
...
var TargetType = exports.TargetType = (_temp = _class = function TargetType() {
    (0, _classCallCheck3.default)(this, TargetType);
}, _class.Class = 'Class', _class.Method = 'Method', _class.Property = 'Property', _temp);
...
function check(annotationClass, imp /*: Object*/) {
    var annotation = new _Reader2.default(annotationClass).getClassAnnotation('Target');
    ...
    if (annotation) {
        ...
        try {
            for (var _iterator = (0, _getIterator3.default)(annotation.targetings), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var targeting = _step.value;
...
exports.default = function (args) {
    return new _Annotation2.default(args, 'dependencies').delegate(Inject);
};
...
var Inject = (_dec = (0, _Target2.default)(['Class', 'Method']), _dec(_class = function () {
    function Inject() {
        (0, _classCallCheck3.default)(this, Inject);
        this.dependencies = [];
    }
    /**
     * @type {Array|string[]}
    ...
    (0, _createClass3.default)(Inject, [{
        key: 'getDependencies',
         ...
         */
        value: function getDependencies() /*: Array*/ {
            return this.dependencies instanceof Array ? this.dependencies : [this.dependencies];
        }
    }]);
    return Inject;
}()) || _class);
...
exports.default = exports.CONTAINER_IDENTIFIER = undefined;

var _toConsumableArray2 = __webpack_require__(106);

var _toConsumableArray3 = _interopRequireDefault(_toConsumableArray2);

var _slicedToArray2 = __webpack_require__(226);
...
var _Registrar = __webpack_require__(211);

var _Registrar2 = _interopRequireDefault(_Registrar);

var _Inject = __webpack_require__(99);

var _Inject2 = _interopRequireDefault(_Inject);

var _Resolver = __webpack_require__(68);

var _Resolver2 = _interopRequireDefault(_Resolver);

var _InvalidAliasError = __webpack_require__(210);

var _InvalidAliasError2 = _interopRequireDefault(_InvalidAliasError);
 ...
 * @type {Symbol}
 */
var CONTAINER_IDENTIFIER = exports.CONTAINER_IDENTIFIER = (0, _symbol2.default)('Container');

/**
 * @type {Symbol}
 */
var RESOLVED_ANY = (0, _symbol2.default)('*');
...
var Container = function () {
     ...
     */
    function Container() {
        var exportAnnotations /*: boolean*/ = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
        ...
        if (exportAnnotations) {
            (global || window).Inject = _Inject2.default;
        }
    ...
    (0, _createClass3.default)(Container, [{
        key: "instance",
        value: function instance(nameOrService /*: ServiceIdentifier*/) /*: Container*/ {
            var service /*: ?any*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        ...
        key: "factory",
        value: function factory(nameOrService /*: ServiceIdentifier*/) /*: Container*/ {
            var service /*: ?any*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        ...
        key: "singleton",
        value: function singleton(nameOrService /*: ServiceIdentifier*/) /*: Container*/ {
            var service /*: ?any*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        ...
        key: "resolving",
        value: function resolving(nameOrService /*: ServiceIdentifier*/) /*: Container*/ {
            var callback /*: ?Function*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            if (callback === null && nameOrService instanceof Function) {
                return this.resolving(RESOLVED_ANY, nameOrService);
            }

            this._getEvents(_Support2.default.getName(nameOrService)).push(callback);
        ...
        key: "_fireResolvedEvents",
        value: function _fireResolvedEvents(serviceName /*: string*/, value /*: any*/) {
            var _iteratorNormalCompletion = true;
            var _didIteratorError = false;
            var _iteratorError = undefined;

            try {
                for (var _iterator = (0, _getIterator3.default)(this._getEvents(serviceName)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            try {
                for (var _iterator2 = (0, _getIterator3.default)(this._getEvents(RESOLVED_ANY)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var _observer = _step2.value;

                    _observer(serviceName, value);
                }
            } catch (err) {
                _didIteratorError2 = true;
                _iteratorError2 = err;
        ...
        key: "_getEvents",
        value: function _getEvents(name /*: string*/) /*: Array*/ {
        ...
        key: "_define",
        value: function _define(nameOrService /*: ServiceIdentifier*/) /*: Registrar*/ {
            var _this = this;

            var service /*: ?any*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            var _Container$_normalise = Container._normaliseBindArguments(nameOrService, service);

            var _Container$_normalise2 = (0, _slicedToArray3.default)(_Container$_normalise, 2);

            nameOrService = _Container$_normalise2[0];
            service = _Container$_normalise2[1];


            return new _Registrar2.default(this, nameOrService, service).resolved(function (name, value) {
                return _this._fireResolvedEvents(name, value);
            });
        }
        ...
        key: "register",
        value: function register(name /*: string*/, resolver /*: Resolver*/) /*: Container*/ {
        ...
        key: "alias",
        value: function alias(original /*: string*/) /*: Container*/ {
            ...
            try {
                for (var _iterator3 = (0, _getIterator3.default)(aliases), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    var alias = _step3.value;

                    if (typeof alias === 'string' && this.isAlias(alias)) {
                        throw _InvalidAliasError2.default.create(alias);
                    }

                    if (this._services[alias]) {
                        throw new _InvalidAliasError2.default("Can not create alias " + alias + ". Service " + alias + " already defined.");
                    }
        ...
        key: "isAlias",
        value: function isAlias(alias /*: string*/) /*: boolean*/ {
        ...
        key: "_getResolver",
        value: function _getResolver(name /*: ServiceIdentifier*/) /*: Resolver*/ {
            name = _Support2.default.getName(name);
        ...
        key: "has",
        value: function has(name /*: ServiceIdentifier*/) /*: boolean*/ {
            return !!this._services[_Support2.default.getName(name)];
        }
        ...
        key: "get",
        value: function get(name /*: ServiceIdentifier*/) /*: any*/ {
        ...
        key: "make",
        value: function make(name /*: ServiceIdentifier*/) /*: any*/ {
        ...
        key: "makeWith",
        value: function makeWith(name /*: ServiceIdentifier*/) /*: any*/ {
            var _getResolver2;

            var args /*: Array*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

            if (!this.has(name) && !this.isAlias(name)) {
                this._define(name).factory();
            }

            return (_getResolver2 = this._getResolver(name)).resolve.apply(_getResolver2, (0, _toConsumableArray3.default)(args));
        }
        ...
        key: "_normaliseBindArguments",
        value: function _normaliseBindArguments(nameOrService /*: ServiceIdentifier*/) /*: Array*/ {
            var service /*: ?ServiceIdentifier*/ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            if (service === null || typeof service === 'undefined') {
                if (!_Support2.default.isClass(nameOrService) && !_Support2.default.isObject(nameOrService)) {
                    throw _InvalidDefinitionError2.default.create(nameOrService);
                }

                return [_Support2.default.getName(nameOrService), nameOrService];
            }
...
exports.default = exports.Option = undefined;
...
var _dec, _dec2, _dec3, _dec4, _dec5, _class2, _desc, _value, _class3, _descriptor, _descriptor2, _descriptor3, _descriptor4;
...
var Option = exports.Option = function Option(value, title /*: ?string*/) {
...
var Dropdown = (_dec = (0, _Component2.default)({
    name: 'ui-dropdown',
    view: __webpack_require__(203),
    style: __webpack_require__(201)
}), _dec2 = (0, _Input2.default)(), _dec3 = (0, _Input2.default)(), _dec4 = (0, _Input2.default)(), _dec5 = (0, _Input2.default)(), _dec(_class2 = (_class3 = function () {
    ...
    function Dropdown() {
        ...
        _initDefineProp(this, "autoSelect", _descriptor4, this);
    ...
    (0, _createClass3.default)(Dropdown, [{
        ...
        value: function create() {
            this.options.subscribe(this._selectDefaultValue.bind(this));
            this.value.subscribe(this._selectDefaultValue.bind(this));
            this.autoSelect.subscribe(this._selectDefaultValue.bind(this));
        ...
        key: "_selectDefaultValue",
        value: function _selectDefaultValue() {
    ...
    return Dropdown;
}(), (_descriptor = _applyDecoratedDescriptor(_class3.prototype, "placeholder", [_dec2], {
    enumerable: true,
    initializer: function initializer() {
        return ko.observable('Select value');
    }
}), _descriptor2 = _applyDecoratedDescriptor(_class3.prototype, "options", [_dec3], {
    enumerable: true,
    initializer: function initializer() {
        return ko.observableArray([]);
    }
}), _descriptor3 = _applyDecoratedDescriptor(_class3.prototype, "value", [_dec4], {
    enumerable: true,
    initializer: function initializer() {
        return ko.observable(null);
    }
}), _descriptor4 = _applyDecoratedDescriptor(_class3.prototype, "autoSelect", [_dec5], {
    enumerable: true,
    initializer: function initializer() {
...
exports.default = function (args) {
  return new _dioma.Annotation(args, 'name').delegate(Component);
};

var _dioma = __webpack_require__(74);
...
exports.default = function (args) {
    return new _dioma.Annotation(args).delegate(Input);
};
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(36)(Function.call, __webpack_require__(20).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var global         = __webpack_require__(2)
  , core           = __webpack_require__(35)
  , LIBRARY        = __webpack_require__(50)
  , wksExt         = __webpack_require__(196)
...
var _ComponentLoader = __webpack_require__(216);

var _ComponentLoader2 = _interopRequireDefault(_ComponentLoader);

var _ViewModelsLoader = __webpack_require__(217);

var _ViewModelsLoader2 = _interopRequireDefault(_ViewModelsLoader);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Application = function (_Container) {
    (0, _inherits3.default)(Application, _Container);

    function Application() {
        (0, _classCallCheck3.default)(this, Application);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Application.__proto__ || (0, _getPrototypeOf2.default)(Application)).call(this, true));

        _this._bindDependencies();

        _this.instance('app', _this);
        _this.make(_ComponentLoader2.default).register('text', 'dropdown');

        _this.ready(function () {
            _this.make(_ViewModelsLoader2.default).named('data-vm').load();
        });
        return _this;
    }
    ...
    (0, _createClass3.default)(Application, [{
        ...
        value: function _bindDependencies() {
            this.instance(new _ComponentLoader2.default(this, function (name) {
                return __webpack_require__(459)("./" + name + "/" + name).default;
            })).alias(_ComponentLoader2.default, 'components').instance(new _ViewModelsLoader2.default(function (name) {
                return __webpack_require__(460)("./" + name).default;
            })).alias(_ViewModelsLoader2.default, 'views');
        }
        ...
        key: "ready",
        value: function ready(callback /*: Function*/) /*: void*/ {
...
(function (factory) {
	...
	if (true) {
		...
		factory(__webpack_require__(155), exports);
...
var InvalidDefinitionError = function (_TypeError) {
    (0, _inherits3.default)(InvalidDefinitionError, _TypeError);

    function InvalidDefinitionError() {
        (0, _classCallCheck3.default)(this, InvalidDefinitionError);
        return (0, _possibleConstructorReturn3.default)(this, (InvalidDefinitionError.__proto__ || (0, _getPrototypeOf2.default)(InvalidDefinitionError)).apply(this, arguments));
    }

    (0, _createClass3.default)(InvalidDefinitionError, null, [{
        key: 'create',
         ...
         */
        value: function create(definition /*: any*/) /*: InvalidDefinitionError*/ {
            var suffix = (typeof definition === 'undefined' ? 'undefined' : (0, _typeof3.default)(definition)) + ' (' + definition + ')';
            ...
            var message = 'Invalid service definition: Class or Object required, ' + suffix + ' given.';
...
var Text = (_dec = (0, _Component2.default)({
  name: 'ui-text',
  view: __webpack_require__(204),
  style: __webpack_require__(202)
}), _dec2 = (0, _Input2.default)(), _dec3 = (0, _Input2.default)(), _dec(_class = (_class2 = function () {
  function Text() {
  ...
  (0, _createClass3.default)(Text, [{
     ...
     * @private
     */
    value: function create(parameters /*: Object*/) {}
  }]);
  return Text;
...
function Search() {
  ...
  this.placeholder = ko.observable(this._placeholders.docs);
  this.value = ko.observable('');
  this.options = ko.observableArray([new _dropdown.Option('docs', 'Документация'), new _dropdown.Option('articles', 'Статьи'), new _dropdown.Option('packages', 'Пакеты')]);
  this.category = ko.observable(null);

  this.category.subscribe(function (option /*: Option*/) {
    _this.placeholder(_this._placeholders[option.value]);
  });
}
...
var global         = __webpack_require__(28)
  ...
  , each           = __webpack_require__(108)(0)
...
module.exports = !__webpack_require__(27) && !__webpack_require__(47)(function(){
...
module.exports = "<div class=\"input dropdown\" data-bind=\"\n    event: {\n        mouseover: function() { hover(true); },\n        mouseout: function() { hover(false); }\n    },\n    css: { active: visible }\n\"> <button class=dropdown-value data-bind=\"click: function() { toggle(); }\"> <!--ko if: value--> <span data-bind=\"text: value().title\"></span> <!--/ko--> <!--ko ifnot: value--> <span class=dropdown-placeholder data-bind=\"text: placeholder\"></span> <!--/ko--> </button> <nav class=dropdown-options data-bind=\"foreach: options, css: { visible: visible }\"> <!--ko ifnot: current()--> <button class=dropdown-option data-bind=\"\n                text: title,\n                css: { active: current },\n                attr: { 'data-value': value },\n                click: function(ctx) { $parent.select(ctx); }\n            \"></button> <!--/ko--> </nav> </div> ";

/***/ }),
/* 204 */
/***/ (function(module, exports) {

module.exports = "<input type=text data-bind=\"value: value, valueUpdate: 'input', attr: {\n    placeholder: placeholder(),\n}\"/> <!--ko if: (value.isValid) && !value.isValid--> <span class=errors> <span class=error> <span data-bind=\"text: value.error\"></span> </span> </span> <!--/ko--> ";
...
(function () {
    ...
    var laroute = function () {
        ...
        var routes = {
            ...
            absolute: false,
            rootUrl: 'https://laravel.dev',
            routes: [{ "host": null, "methods": ["GET", "HEAD"], "uri": "graphql\/{graphql_schema?}", "name": "graphql.query", "action": "Folklore\GraphQL\GraphQLController@query" }, { "host": null, "methods": ["POST"], "uri": "graphql\/{graphql_schema?}", "name": "graphql.mutation", "action": "Folklore\GraphQL\GraphQLController@query" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "graphiql", "name": "graphql.graphiql", "action": "Closure" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "_debugbar\/open", "name": "debugbar.openhandler", "action": "Barryvdh\Debugbar\Controllers\OpenHandlerController@handle" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "_debugbar\/clockwork\/{id}", "name": "debugbar.clockwork", "action": "Barryvdh\Debugbar\Controllers\OpenHandlerController@clockwork" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "_debugbar\/assets\/stylesheets", "name": "debugbar.assets.css", "action": "Barryvdh\Debugbar\Controllers\AssetController@css" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "_debugbar\/assets\/javascript", "name": "debugbar.assets.js", "action": "Barryvdh\Debugbar\Controllers\AssetController@js" }, { "host": null, "methods": ["OPTIONS"], "uri": "graphql", "name": null, "action": "Closure" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "\/", "name": "home", "action": "App\Http\Controllers\HomeController@index" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "react\/{path?}", "name": null, "action": "App\Http\Controllers\HomeController@react" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "login", "name": "login", "action": "App\Http\Controllers\Auth\LoginController@index" }, { "host": null, "methods": ["POST"], "uri": "login", "name": null, "action": "App\Http\Controllers\Auth\LoginController@login" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "register", "name": "registration", "action": "App\Http\Controllers\Auth\RegistrationController@index" }, { "host": null, "methods": ["POST"], "uri": "register", "name": null, "action": "App\Http\Controllers\Auth\RegistrationController@register" }, { "host": null, "methods": ["GET", "POST", "HEAD"], "uri": "logout", "name": "logout", "action": "App\Http\Controllers\Auth\LoginController@logout" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "confirmed", "name": "confirmation.confirmed", "action": "App\Http\Controllers\Auth\ConfirmationController@index" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "confirm\/{token}", "name": "confirmation.confirm", "action": "App\Http\Controllers\Auth\ConfirmationController@confirm" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "articles", "name": "articles", "action": "App\Http\Controllers\ArticlesController@index" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "articles\/{slug}", "name": "articles.show", "action": "App\Http\Controllers\ArticlesController@show" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "articles\/tag\/{id}", "name": "tag", "action": "App\Http\Controllers\ArticlesController@indexForTag" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "docs", "name": "docs", "action": "App\Http\Controllers\DocsController@index" }, { "host": null, "methods": ["GET", "HEAD"], "uri": "docs\/{version}\/{slug}", "name": "docs.show", "action": "App\Http\Controllers\DocsController@show" }],
            prefix: '',
...
var InvalidAliasError = function (_TypeError) {
    (0, _inherits3.default)(InvalidAliasError, _TypeError);

    function InvalidAliasError() {
        (0, _classCallCheck3.default)(this, InvalidAliasError);
        return (0, _possibleConstructorReturn3.default)(this, (InvalidAliasError.__proto__ || (0, _getPrototypeOf2.default)(InvalidAliasError)).apply(this, arguments));
    }

    (0, _createClass3.default)(InvalidAliasError, null, [{
        key: 'create',
         ...
         */
        value: function create(alias /*: any*/) /*: InvalidAliasError*/ {
            var suffix = typeof alias === 'string' ? 'Alias "' + alias + '" already defined.' : 'Alias must be a string.';

            var message = 'Invalid service alias. ' + suffix;
...
exports.default = InvalidAliasError;
...
var _FactoryResolver = __webpack_require__(212);

var _FactoryResolver2 = _interopRequireDefault(_FactoryResolver);

var _InstanceResolver = __webpack_require__(213);

var _InstanceResolver2 = _interopRequireDefault(_InstanceResolver);

var _SingletonResolver = __webpack_require__(214);

var _SingletonResolver2 = _interopRequireDefault(_SingletonResolver);
...
var Registrar = function () {
   ...
   * @private
   */
  function Registrar(container /*: Container*/, name /*: string*/, service /*: any*/) {
    (0, _classCallCheck3.default)(this, Registrar);

    this._resolvedEvent = function () {};
  ...
  (0, _createClass3.default)(Registrar, [{
    key: "resolved",
    value: function resolved(callback /*: Function*/) /*: Registrar*/ {
      this._resolvedEvent = callback;
    ...
    key: "alias",
    value: function alias(_alias /*: string*/) /*: Registrar*/ {
      this._container.alias(this._name, _alias);
    ...
    key: "singleton",
    value: function singleton() /*: Registrar*/ {
      this._container.register(this._name, this._createResolver(_SingletonResolver2.default));
    ...
    key: "factory",
    value: function factory() /*: Registrar*/ {
      this._container.register(this._name, this._createResolver(_FactoryResolver2.default));
    ...
    key: "instance",
    value: function instance() /*: Registrar*/ {
      this._container.register(this._name, this._createResolver(_InstanceResolver2.default));
    ...
    key: "_createResolver",
    value: function _createResolver(resolver /*: Function*/) /*: Resolver*/ {
      var _this = this;

      return new resolver(this._container, this._service).resolved(function (item) {
        return _this._resolvedEvent(_this._name, item);
      });
    }
  }]);
  return Registrar;
...
var _Resolver2 = __webpack_require__(68);
...
var FactoryResolver = function (_Resolver) {
    (0, _inherits3.default)(FactoryResolver, _Resolver);

    function FactoryResolver() {
        (0, _classCallCheck3.default)(this, FactoryResolver);
        return (0, _possibleConstructorReturn3.default)(this, (FactoryResolver.__proto__ || (0, _getPrototypeOf2.default)(FactoryResolver)).apply(this, arguments));
    }

    (0, _createClass3.default)(FactoryResolver, [{
        key: "resolve",
         ...
         */
        value: function resolve() /*: any*/ {
            var dependencies = this.getDependencies.apply(this, arguments);

            var result = _Support2.default.isAnonymous(this.service) ? this.service.apply(this, (0, _toConsumableArray3.default)(dependencies)) : new (Function.prototype.bind.apply(this.service, [null].concat((0, _toConsumableArray3.default)(dependencies))))();
...
exports.default = FactoryResolver;
...
var InstanceResolver = function (_Resolver) {
    (0, _inherits3.default)(InstanceResolver, _Resolver);

    function InstanceResolver() {
        (0, _classCallCheck3.default)(this, InstanceResolver);
        return (0, _possibleConstructorReturn3.default)(this, (InstanceResolver.__proto__ || (0, _getPrototypeOf2.default)(InstanceResolver)).apply(this, arguments));
    }

    (0, _createClass3.default)(InstanceResolver, [{
        key: "resolve",
...
var SingletonResolver = function (_Resolver) {
    (0, _inherits3.default)(SingletonResolver, _Resolver);
    ...
    function SingletonResolver() {
        ...
        (0, _classCallCheck3.default)(this, SingletonResolver);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = SingletonResolver.__proto__ || (0, _getPrototypeOf2.default)(SingletonResolver)).call.apply(_ref, [this].concat(args))), _this), _this._instance = null, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
    }
    /**
     * @type {Object|null}
     * @private
    ...
    (0, _createClass3.default)(SingletonResolver, [{
        key: "resolve",
        ...
        value: function resolve() /*: any*/ {
            if (this._instance === null) {
                ...
                this._instance = _Support2.default.isAnonymous(this.service) ? this.service.apply(this, (0, _toConsumableArray3.default)(dependencies)) : new (Function.prototype.bind.apply(this.service, [null].concat((0, _toConsumableArray3.default)(dependencies))))();
...
exports.default = SingletonResolver;
...
var _knockout = __webpack_require__(155);

var _knockout2 = _interopRequireDefault(_knockout);

var _router = __webpack_require__(205);
...
var _Application = __webpack_require__(153);

var _Application2 = _interopRequireDefault(_Application);

var _knockoutInview = __webpack_require__(208);

var _knockoutInview2 = _interopRequireDefault(_knockoutInview);
...
_knockout2.default.bindingHandlers.inview = (0, _knockoutInview2.default)(_knockout2.default);

/**
 * Validation support
 */

_knockout2.default.validation.configuration.insertMessages = false;
_knockout2.default.validation.locale('ru-RU');
...
var ComponentLoader = (_dec = (0, _Inject2.default)(['app']), _dec(_class = function () {
     ...
     * @private
     */
    function ComponentLoader(app /*: Application*/, resolver /*: Function*/) {
        (0, _classCallCheck3.default)(this, ComponentLoader);

        this._resolver = function (path) {};
    ...
    (0, _createClass3.default)(ComponentLoader, [{
        key: "register",
        value: function register() {
            ...
            try {
                for (var _iterator = (0, _getIterator3.default)(components), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    var cls = this._resolver(component);
                    var reader = new _dioma.Reader(cls);
        ...
        key: "_loadComponent",
        value: function _loadComponent(ctx, reader /*: Reader*/) {
            var _this = this;

            var annotation = reader.getClassAnnotation('Component');

            ko.components.register(annotation.name, {
                viewModel: function viewModel(args) {
                    var instance = _this._app.make(ctx);

                    _this._applyArguments(reader, args, instance);
        ...
        key: "_applyArguments",
        value: function _applyArguments(reader /*: Reader*/) {
            var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            var instance /*: Object*/ = arguments[2];
            var _iteratorNormalCompletion2 = true;
            var _didIteratorError2 = false;
            var _iteratorError2 = undefined;

            try {
                for (var _iterator2 = (0, _getIterator3.default)((0, _keys2.default)(args)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var property = _step2.value;

                    var input = reader.getPropertyAnnotation('Input', property);
...
var ViewModelsLoader = function () {
   ...
   * @private
   */
  function ViewModelsLoader(resolver /*: Function*/) {
    (0, _classCallCheck3.default)(this, ViewModelsLoader);
    this._root = document.body;

    this._resovler = function (name) {};
  ...
  (0, _createClass3.default)(ViewModelsLoader, [{
    key: 'named',
    value: function named(query) {
      this._query = query;
    ...
    key: '_load',
    value: function _load(root) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = (0, _getIterator3.default)(root.querySelectorAll('[' + this._query + ']')), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var node = _step.value;

          var name = node.getAttribute(this._query);
          var cls = this._resovler(name);
          var instance = new cls(node);
...
exports.default = ViewModelsLoader;
...
var _isIterable2 = __webpack_require__(219);
...
module.exports = __webpack_require__(11).Reflect.defineMetadata;
...
module.exports = __webpack_require__(11).Reflect.getMetadata;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(59)(Function.call, __webpack_require__(169).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch(e){ buggy = true; }
      return function setPrototypeOf(O, proto){
...
var metadata                  = __webpack_require__(168)
  , anObject                  = __webpack_require__(22)
...
$export($export.P + $export.F * (__webpack_require__(72) != Object || !__webpack_require__(26)(arrayJoin)), 'Array', {
...
$export($export.S, 'Number', {isInteger: __webpack_require__(182)});
...
var $export     = __webpack_require__(0)
  , $parseFloat = __webpack_require__(192);
...
__webpack_require__(7) && $export($export.P + __webpack_require__(93), 'Object', {
...
var $export  = __webpack_require__(0)
  , $entries = __webpack_require__(190)(true);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(0)
  , $values = __webpack_require__(190)(false);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(152), __webpack_require__(457)))
...
var map = {
	"./dropdown/dropdown": 101,
	"./dropdown/dropdown.html": 203,
	"./dropdown/dropdown.js": 101,
	"./dropdown/dropdown.scss": 201,
	"./text/text": 157,
	"./text/text.html": 204,
	"./text/text.js": 157,
	"./text/text.scss": 202
