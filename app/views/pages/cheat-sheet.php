...
<div class="fixed">
	<nav class="top-bar" data-topbar>
		<ul class="title-area">
			<li class="name"><h1><a href="#">Подсказки Laravel</a></h1></li>
		</ul>
		<section class="top-bar-section">
			<ul class="right">
				<li class="comments-toggle"><a href="#"><i class="icon-comments"></i> Убрать/показать комментарии</a></li>
				<li><a href="/">Laravel.ru</a></li>
			</ul>
		</section>
	</nav>
</div>
	...
	<div class="small-10 small-offset-1 large-6 large-offset-3 columns">
		<div class="row collapse">
			<div class="small-10 columns">
				<input type="text" placeholder="Начните печатать..." id="search" name="search" />
			</div>
...
// Показать хэлп по данной команде
php artisan --help ИЛИ -h
// Не выводить собщений
php artisan --quiet ИЛИ -q
// Версия используемого фрейморка
php artisan --version ИЛИ -V
// Не спрашивать ничего у пользователя
php artisan --no-interaction ИЛИ -n
// Разрешить вывод цветного текста в консоли
php artisan --ansi
// Запретить цвет
php artisan --no-ansi
// Назначить среду выполнения для команды
php artisan --env=foo
// -v|vv|vvv Количество выводимых сообщений (если поддерживается): 1 - обычное, 2 - больше сообщений and 3 - отладка
php artisan --verbose

// Посмотреть список изменений текущей версии фреймворка
php artisan changes
// Удалить автосоздаваемый compiled.php
php artisan clear-compiled
// Остановить приложение (включить режим обслуживания)
php artisan down
// Обновить файлы автозагрузки composer
php artisan dump-autoload
// Название текущей среды выполнения
php artisan env
// Показать хэлп по данной команде
php artisan help
// Список команд
...
<script src="cheatsheet/js/jquery.js"></script>
<script src="cheatsheet/js/jquery.highlight-4.js"></script>
<script src="cheatsheet/js/foundation.min.js"></script>
<script src="cheatsheet/js/prettify.js"></script>
<script src="cheatsheet/js/app.js"></script>
