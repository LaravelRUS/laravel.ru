...
return [
	...
	*/
	...
	"notname" => "Запрещено использование имен собственных и их вариаций.",
	"antispam" => "Антиспам-проверка не пройдена.",
	"spam" => "Некорректные символы в email",
	"allowedsymbols" => "Некорректные символы в никнейме.",
	"spaces" => "Запрещено использовать несколько пробелов подряд.",
	"firstdigit" => "Никнейм не может начинаться с цифры.",
	"onetypeletters" => "Нельзя сочетать буквы разных языков - строка должна быть или только с английскими или только с русскими буквами",
	"invite" => "Регистрация с данным инвайтом невозможна.",

	"slug" => "Slug может состоять из латинских символов, дефиса, начинаться и заканчиваться буквой или цифрой",
	"social" => "Указаны некорретные данные",
	"username" => "Логин может состоять из латинских символов, цифр, одинарного дефиса или точки. Он должен начинаться с буквы, заканчиваться буквой или цифрой и содержать от 4 до 23 символов",
    "password_check" => "Старый пароль введен неверно",
	...
	*/
	...
	'custom' => [
	    ...
	    'avatar' => [
	        ...
	        'image' => 'Выбранное выми фото не является корректным изображением',
	        'max' => 'Максимально допустимый размер фото 1024 Кб',
	    ],
	    'password_old' => [
	...
	*/
	...
	'attributes' => [
		...
		'size' => "Размер",
	    'birthday' => "Дeнь рождения",

		"password_old" => "Старый пароль",
		"password_new" => "Новый пароль",
		"password_new_confirmation" => "Повтор пароля",
		"email" => "Email",
	],
