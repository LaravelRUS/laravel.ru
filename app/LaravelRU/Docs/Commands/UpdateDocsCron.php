...
class UpdateDocsCron extends ScheduledCommand
{
    ...
    public function fire()
    {
        ...
        foreach ($all_versions as $id => $version) {
            ...
            if ($force_file) {
                if ($forceupdate) {
                    Document::whereHas('version', function ($query) {
                    })->name($force_file)->delete();
