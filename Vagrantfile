...
mariadb_version       = "5.5"   # Options: 5.5 | 10.0
mariadb_root_password = "123"   # We'll assume user "root"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "laravel-su.dev"

  # Create a static IP
  config.vm.network :private_network, ip: server_ip

  # Use NFS for the shared folder
#  config.vm.synced_folder ".", "/var/www/laravel-su.dev",
#           id: "core",
#            :nfs => true,
